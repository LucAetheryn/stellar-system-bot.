...
class Owner(commands.Cog):
    ...
    async def owner(self, ctx):
        ...
        embed.add_field(name="<a:Spotify:1468872357165793324> Spotify", value="<a:Arrow:820637327969746974> [Lucky Praditya](https://open.spotify.com/user/nr1804ww5fuzdnmh4o3nkce06)", inline=True)
